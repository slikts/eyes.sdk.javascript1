...
describe('CheckSettings', () => {
  ...
  it('sets shadow selector with string', () => {
    ...
    assert.deepStrictEqual(checkSettings._settings, {region: {selector: 'el-with-shadow', shadow: {selector: 'el'}}})
  })
  ...
  it('sets shadow selector with string', () => {
    ...
    assert.deepStrictEqual(checkSettings._settings, {
      region: {selector: {fakeSelector: 'el-with-shadow'}, shadow: {selector: {fakeSelector: 'el'}}},
    })
  })
})
